...
describe("Data selector tests", () => {
    ...
    it("should get all active selection names", () => {
        ...
        // turn it on
        state = reducer(state, actions.selectionToggle(0));
        // check whether it's off
        ...
        // add another
        state = reducer(state, actions.selectionCreate("s2", List([false, false]), false, "red"));
    ...
    it("should create points from selections", () => {
        ...
        expect(points.toJS()).toEqual([[1, 2], [3, 4], [5, 6], [7, 8]]);
    });
    it("should zip points and selections", () => {
        ...
        state = reducer(state, act2);
        state = reducer(state, actions.selectionToggle(0));
        state = reducer(state, actions.selectionToggle(1));
    ...
    it("should get points based on feature and mask", () => {
        ...
        expect(testX.toJS()).toEqual([[1, 2], [3, 4], [5, 6], [7, 8]]);
        expect(test1.toJS()).toEqual([[1, 2], [3, 4], [], []]);
        expect(test2.toJS()).toEqual([[1, 2], [], [5, 6], []]);
    });
});
