...
function ParameterSection(props) {
    ...
    return (
        <div className="parameter-section">
            <Typography variant="h6">Parameter Section</Typography>
...
function InputSelections(props) {
    return (
        <div className="input-selections">
            <Typography variant="h6">Input Selections</Typography>
...
function GeneralClassifier(props) {
    ...
    function makeOutputMessage(names) {
        return (
            "General Classifications have been made and outputed as selections under the names: \n" +
            names.map(name => {
                return name + "\n";
            })
        );
        ...
        <div className="gc-container">
            ...
            <div className="non-header-container">
                <div className="gc-left-side">
                    <InputSelections activeSelections={activeSelections} />
                </div>
