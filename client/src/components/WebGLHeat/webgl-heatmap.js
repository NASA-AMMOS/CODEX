        ...
        this.WebGLHeatmap = (function() {
            function WebGLHeatmap(_arg) {
                ...
                if (window.WebGLDebugUtils != null) {
                    ...
                    this.gl = window.WebGLDebugUtils.makeDebugContext(this.gl, function(
                        err,
                        funcName,
                        args
                    ) {
                        throw window.WebGLDebugUtils.glEnumToString(err) +
                ...
                if (gradientTexture) {
                    ...
                    getColorFun =
                        ...
                        "\n    return vec4( texture2D(gradientTexture, vec2(intensity * " +
                        gradientWidth +
                        ".0, 0.0)).rgb, intensity * 255.0 );" +
                        "}";
                } else {
