...
class Sparkline extends React.Component {
    ...
    renderPath() {
        ...
        const maskOffset =
            this.props.completeFrom === "right" ? this.getParentWidth() - maskWidth : 0;

        return (
            <svg preserveAspectRatio="none" width={this.getParentWidth()} height="100%">
                <path className="sparkline" d={sparklinePath} />
                <rect
                    x={maskOffset}
                    y="0"
