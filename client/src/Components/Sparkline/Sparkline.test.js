...
describe("<Sparkline/>", () => {
    it("renders without crashing", () => {
        ...
        ReactDOM.render(<Sparkline data={[1, 2, 3, 4, 5]} />, div);
    });

    it("renders the proper tree", () => {
        const wrapper = shallow(<Sparkline data={[1, 2, 3, 4, 5]} />);
    ...
    it("renders a path", () => {
        const wrapper = mount(<Sparkline data={[1, 2, 3, 4, 5]} />);
    ...
    it("scales the occlusion rect", () => {
        const wrapper = mount(<Sparkline completion={0.35} data={[1, 2, 3, 4, 5]} />);
