...
import "components/DimensionalityReduction/Parameters/Parameters.css";
...
import simplescatter from "components/DimensionalityReduction/simplescatter";
    ...
    constructor(props) {
        ...
        for (let p in this.t.parameters) {
            ...
            if (this.t.parameters[p].name === "n_components")
                defaultParameters[this.t.parameters[p].name] = getSelectedFeatures(
                    this.props.data
                ).size;
        }
                        ...
                        <li>
                            ...
                            <div id="paramtoolbar">
                                <input
                                    ...
                                    defaultValue={
                                        this.t.parameters[i].name === "n_components"
                                            ? getSelectedFeatures(this.props.data).size
                                            : this.state.parameterValues[i]
                                    }
