import "components/Cluster/Cluster.css";
...
import Help from "components/Cluster/Help/Help";
...
class Cluster extends Component {
    ...
    */
    ...
    chosenUpdate(chosenFeatures, chosenSelections) {
        ...
        } else this.updateCall({ dataFeatures: chosenFeatures, dataSelections: chosenSelections });

        if (this.ref.subAlgorithms) this.ref.subAlgorithms.update();
        if (this.ref.algorithmContainer) this.ref.algorithmContainer.update();
    }
    ...
    finalReaction(r) {
        ...
        if (this.props.windowId !== null) manager.removeWindow(this.props.windowId);
    }
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            !formulas.compareArrays(this.vars.call.dataFeatures, chosenFeatures) ||
            !formulas.compareArrays(this.vars.call.dataSelections, chosenSelections)
        ) {
            this.setRefreshCountdown(this.chosenUpdate, chosenFeatures, chosenSelections, true);
        }
    }
        ...
        return (
            ...
            >
                ...
                <div className="right">
                    ...
                    <SubAlgorithms
                        ref={r => {
                            this.ref.subAlgorithms = r ? r.getWrappedInstance() : null;
                        }}
                        invoke={(c, r, p, v) => {
                            this.clusterInvoke(c, r, p, v);
                        }}
