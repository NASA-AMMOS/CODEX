...
class WindowGroup extends Component {
    ...
    render() {
        return (
            ...
            >
                <ContextMenuTrigger
                    id={"WindowGroupContextMenu__" + this.groupId}
                    holdToDisplay={-1}
                >
                    <Rnd
                        ref={r => {
                    ...
                    >
                        <div
                            className="WindowGroupContent"
                            id={"WindowGroupContent__" + this.groupId}
                            ref={wc => {
                                this.ref_wc = wc;
                            }}
                        >
                            <div
                                className={
                                    "WindowGroupHandle__" + this.groupId + " WindowGroupHandle"
                                }
                                ref={wh => {
                                    this.ref_wh = wh;
                                }}
