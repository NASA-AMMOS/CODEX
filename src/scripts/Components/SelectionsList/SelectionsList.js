        ...
        return (
            <Fragment key={index}>
                <li
                    ...
                    <div
                        ...
                        onContextMenu={e => {
                            ...
                            if( this.state.editedColor === index )
                                ...
                                this.setState({editedColor: index})
                        }}
                        style={style}>
                    </div>
                    ...
                    <ContextMenuTrigger id={menuID} attributes={{className:'SelectionsList__Trigger'}}>
                ...
                <ContextMenu id={menuID}>
                    ...
                    <MenuItem divider />
                    <MenuItem className="SelectionsList--danger" onClick={() => this.props.selectionRemove(index)}>
                        Remove "{name}"
                    </MenuItem>
                </ContextMenu>
            </Fragment>
        ...
        const selections = this.props.selections
            ...
            .filter( n => {
				switch( this.props.onOffAll ) {
					case 'all':
						...
						return n.name.toLowerCase().indexOf(this.props.filterString.toLowerCase()) !== -1
						break;
					case 'on':
						if ( this.props.filterString === '' && n.visible ) return true	
						return n.name.toLowerCase().indexOf(this.props.filterString.toLowerCase()) !== -1 && n.visible
						break;
					case 'off':
						if ( this.props.filterString === '' && !n.visible ) return true	
						return n.name.toLowerCase().indexOf(this.props.filterString.toLowerCase()) !== -1 && !n.visible
            ...
            .map((el, i) => (
                <div key={`sel-sort-${i}`}>
                    <SortableItem
                        index={i}
                        helperClass="SelectionsList__dragged"
                        value={el}/>
                    { (i === this.state.editedColor) ?
                        <div
                            className='selectionListPopover'>
                            <div className='selectionListPopoverArrow'></div>
                            <SketchPicker
                            ...
                            <div
                                ...
                                onClick={ () => {
                                    this.setState({editedColor: null})
                                    this.props.selectionRecolor(i, this._refs.colorBoxes[i].style.backgroundColor)
                                } }
                            >Done</div>
                        </div> : <span></span>
                    }
            ...
            <div className="SelectionsList">
                <div className="SelectionsList__title">
                    <div className="SelectionsList__align">
                        ...
                        <span className="SelectionsList__summary">{activeCount}/{shownCount}/{totalCount}</span>
