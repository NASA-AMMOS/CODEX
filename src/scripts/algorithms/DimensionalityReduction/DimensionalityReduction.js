...
class DimensionalityReduction extends Component {
    ...
    */
    ...
    this.vars = {
      ...
      call: {
        ...
        parameters: {
          n_components: dataFeatures.length,
          downsampled: 10
        }
      },
      estimatedRunTime: 0,
    ...
    controller.subscribeChosenFeaturesUpdateMiddleWare(
        this.setRefreshCountdown.bind(this), 'algorithm',
  ...
  */
  chosenUpdate() {
    ...
    if( dataFeatures.length <= 1 ) {
      ...
      this.updateCall( { dataFeatures: dataFeatures, dataSelections: dataSelections } );
  }
  ...
  */
  ...
  finalReaction( r ) {
    ...
    let meta = {
      creationId: r.cid,
      createdBy: 'DimensionalityReduction',
    ...
    if( this.props.windowId !== null )
      controller.manager.removeWindow( this.props.windowId );
  }
    ...
    return (
      <div className={clusterClass}
        ...
        <div className='right'>
          <div id='title'>
            <div id='name'>
              <HelpTriggerableName
                name=''
                guidancePath='dimensionality_reduction_page:general_dimensionality_reduction'
          ...
          <SubAlgorithms
              ref={(r) => { this.ref.subAlgorithms = r; }}
              invoke={ (c,r,p,v) => { this.clusterInvoke(c,r,p,v) } }
              updateCall={ (c,p,a) => { this.updateCall(c,p,a) } }
        ...
        <Help
          ...
          parent={() => document.getElementsByClassName('DimensionalityReduction')[0].parentElement}
