...
var NodeWidget = exports.NodeWidget = function (_React$Component) {
  ...
  _createClass(NodeWidget, [{
    ...
    value: function render() {
      ...
      var items = _lodash2.default.isArray(children) ? children.map(function (child) {
        return _react2.default.cloneElement(child, { diagramEngine: diagramEngine });
      }) : _react2.default.cloneElement(children, { diagramEngine: diagramEngine });
