...
wikiAddress = 'https://github.jpl.nasa.gov/jackal/CODEX.wiki.git'
...
def updateCoverage():
    ...
    '''
    rc = subprocess.call(f'pytest {PROJECT_ROOT} -v --cov --cov-report html:{join(PROJECT_ROOT, "../tools/website/cov")}', shell=True)
