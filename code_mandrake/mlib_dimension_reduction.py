...
def ICA( feature_array, n_components = None, algorithm = 'parallel', whiten = True, fun = 'logcosh', fun_args = None, max_iter = 200, tol = 0.0001, w_init = None, random_state = None):
...
def TSNE( feature_array, pca_dim = None, output_dim = 2, perplexity = 30, theta = 0.5):
    ...
    (-19.335764447408916, 20.253390318464856, -0.18177986447333205)

    >>> N.min(y), N.max(y), N.median(y)
    (-19.802261875710176, 20.583289206047603, -0.13572348090588071)
